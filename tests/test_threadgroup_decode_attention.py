...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1, 16, 2, 128, 16, mx.float16),
        (1, 16, 2, 64, 10, mx.bfloat16),
    ],
)
def test_threadgroup_decode_attention_matches_reference(B, MAX_S, H, D, lengths, dtype):
    mx.random.seed(206)
    ...
    got = decode_attention(q, K_cache, V_cache, lengths=lengths, backend="metal_threadgroup")
